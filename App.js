...
import AboutWebview from "./src/OtherPages/AboutWebview";
import ContactWebview from "./src/OtherPages/ContactWebview";
      ...
      >
        ...
        >
          <Image
            ...
            source={require("./src/Images/logoBig.png")}
          />
          <Text
            style={{
              color: "#fff",
        ...
        <ScrollView>
          <View style={{ marginLeft: 5 }}>
            ...
            {storedType != "" && listing_type == "paid"  ? (
              ...
              >
                <View style={{ flexDirection: "row", margin: 10 }}>
                  <AntIcon name="dropbox" size={17} color={"#9b59b6"} />
                  <Text
                    style={{
                      marginLeft: 20,
                      fontSize: 15,
            ...
            {storedType != "" && permissionChat === "allow"  ? (
              ...
              >
                <View style={{ flexDirection: "row", margin: 10 }}>
                  <AntIcon name="message1" size={17} color={"#3d4461"} />
                  <Text
                    style={{
                      marginLeft: 20,
                      fontSize: 15,
 ...
 {storedType != "" && this.state.ApplicationAccessServcie === "yes" ? (
              <Collapse>
                    <CollapseHeader>
                        <View style={{
                          ...
                          borderRadius:5,
                          marginBottom:5}}>
                                              <AntIcon name='layout' color={"#2ecc71"} size={20} style={{        alignSelf: 'center',
                          textAlign: 'center',
                          marginLeft: 10}}/>
                          ...
                          paddingVertical:20,
                                              ...
                                              <SimpleLineIcons name='arrow-right' color={'#767676'} size={15} style={{     alignSelf: 'center',
                          position:'absolute',
                          right:10}}/>
                        </View>
                    </CollapseHeader>
                    <CollapseBody style={{paddingHorizontal:20}}>
                      {
                        ...
                        <TouchableOpacity  onPress={() => this.props.navigation.navigate("PostJob")} style={{marginLeft:30, borderLeftWidth:1,
                          borderRadius:0.5,
                          borderStyle: 'dashed',
                          paddingTop:10,
                          paddingBottom:10,
                     ...
                     {
                        storedType != "" && storedType == "employer" && 
                        <TouchableOpacity onPress={()=> this.props.navigation.navigate("PostedJobs")} style={{marginLeft:30, borderLeftWidth:1,
                          borderRadius:0.5,
                          borderStyle: 'dashed',
                          paddingTop:10,
                          paddingBottom:10,
                     ...
                     
                     {
                        ...
                        <TouchableOpacity onPress={()=> this.props.navigation.navigate("LatestProposals")} style={{marginLeft:30, borderLeftWidth:1,
                          borderRadius:0.5,
                          borderStyle: 'dashed',
                          paddingTop:10,
                          paddingBottom:10,
                     ...
                     <TouchableOpacity onPress={()=> this.props.navigation.navigate("OngoingJobs")} style={{marginLeft:30, borderLeftWidth:1,
                      borderRadius:0.5,
                      borderStyle: 'dashed',
                      paddingTop:10,
                      paddingBottom:10,
                     ...
                     <TouchableOpacity onPress={()=> this.props.navigation.navigate("CompletedServices")} style={{marginLeft:30, borderLeftWidth:1,
                      borderRadius:0.5,
                      borderStyle: 'dashed',
                      paddingTop:10,
                      paddingBottom:10,
                     ...
                     <TouchableOpacity onPress={()=> this.props.navigation.navigate("CancelledServices")} style={{marginLeft:30, borderLeftWidth:1,
                      borderRadius:0.5,
                      borderStyle: 'dashed',
                      paddingTop:10,
                      paddingBottom:10,
              ...
              <Collapse>
                    <CollapseHeader>
                        <View style={{
                          ...
                          borderRadius:5,
                          marginBottom:5}}>
                                              <AntIcon name='customerservice' color={'blue'} size={20} style={{        alignSelf: 'center',
                          textAlign: 'center',
                          marginLeft: 10}}/>
                                              <Text style={{ fontSize:14,
                          color:'#24355a',
                          paddingLeft:20,
                          paddingVertical:20,
                                              }}>{CONSTANT.DrawerManageServices}</Text>
                                              <SimpleLineIcons name='arrow-right' color={'#767676'} size={15} style={{     alignSelf: 'center',
                          position:'absolute',
                          right:10}}/>
                        </View>
                    ...
                    <CollapseBody style={{paddingHorizontal:20}}>
                      {
                        storedType != "" && storedType == "freelancer" && 
                        <TouchableOpacity  onPress={() => this.props.navigation.navigate("PostService")} style={{marginLeft:30, borderLeftWidth:1,
                          borderRadius:0.5,
                          borderStyle: 'dashed',
                          paddingTop:10,
                          paddingBottom:10,
                          borderLeftColor:'#767676'}}>
                           <Text style={{color:"#767676"}}>----  {CONSTANT.DrawerPostService}</Text>
                         </TouchableOpacity>
                      }
                     
                     {
                        storedType != "" && storedType == "freelancer" && 
                        <TouchableOpacity onPress={()=> this.props.navigation.navigate("PostedServices")} style={{marginLeft:30, borderLeftWidth:1,
                          borderRadius:0.5,
                          borderStyle: 'dashed',
                          paddingTop:10,
                          paddingBottom:10,
                          borderLeftColor:'#767676'}}>
                           <Text style={{color:"#767676"}}>----  {CONSTANT.DrawerPostedServices}</Text>
                         </TouchableOpacity>
                      }
                     
                     {
                        storedType != "" && storedType == "freelancer" && 
                        <TouchableOpacity onPress={()=> this.props.navigation.navigate("AddonsServices")} style={{marginLeft:30, borderLeftWidth:1,
                          borderRadius:0.5,
                          borderStyle: 'dashed',
                          paddingTop:10,
                          paddingBottom:10,
                          borderLeftColor:'#767676'}}>
                           <Text style={{color:"#767676"}}>----  {CONSTANT.DrawerAddonServices}</Text>
                         </TouchableOpacity>
                      }
                    
                     <TouchableOpacity onPress={()=> this.props.navigation.navigate("OngoingServices")} style={{marginLeft:30, borderLeftWidth:1,
                      borderRadius:0.5,
                      borderStyle: 'dashed',
                      paddingTop:10,
                      paddingBottom:10,
                      borderLeftColor:'#767676'}}>
                       <Text style={{color:"#767676"}}>----  {CONSTANT.DrawerOngoingServices}</Text>
                     </TouchableOpacity>
                     <TouchableOpacity onPress={()=> this.props.navigation.navigate("CompletedServices")} style={{marginLeft:30, borderLeftWidth:1,
                      borderRadius:0.5,
                      borderStyle: 'dashed',
                      ...
                      paddingBottom:10,
                      borderLeftColor:'#767676'}}>
                       <Text style={{color:"#767676"}}>----  {CONSTANT.DrawerCompletedServices}</Text>
                     </TouchableOpacity>
                     <TouchableOpacity onPress={()=> this.props.navigation.navigate("CancelledServices")} style={{marginLeft:30, borderLeftWidth:1,
                      borderRadius:0.5,
                      borderStyle: 'dashed',
                      ...
                      paddingBottom:10,
                      borderLeftColor:'#767676'}}>
                       <Text style={{color:"#767676"}}>----  {CONSTANT.DrawerCancelledServices}</Text>
                     </TouchableOpacity>
                    </CollapseBody>
                </Collapse>
            ) : null}
            ...
            <TouchableOpacity
              onPress={() =>
                ...
                this.props.navigation.navigate("AboutWebview", { url: "https://digitalmarket.com/about" })
              }
            >
              <View style={{ flexDirection: "row", margin: 10 }}>
            ...
            { <TouchableOpacity
               onPress={() =>
                Linking.openURL('market://details?id=com.digitalmarketgg') 
              }
            ...
            <TouchableOpacity
              onPress={() =>
                this.props.navigation.navigate("ContactWebview", { url: "https://digitalmarket.com/contact-us" })
              }
            >
              <View style={{ flexDirection: "row", margin: 10 }}>
