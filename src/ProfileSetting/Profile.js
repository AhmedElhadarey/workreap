    ...
    axios
      ...
      .then(async response => {
        if (response.data.type === "success") {
          ...
          await AsyncStorage.setItem("Location", response.data.location.toString());
          await AsyncStorage.setItem("Noemployees",response.data.no_of_employees.toString());
          await AsyncStorage.setItem("Department", response.data.department);
          await AsyncStorage.setItem("Rate", response.data.per_hour_rate.toString());
              ...
              >
                <View style={{ flexDirection: "column", width: "100%" }}>
                  ...
                  >
                    ...
                    >{`${entities.decode(latitude)}`}</TextInput>
                  </View>
                  <View
                    style={{
                      borderBottomColor: "#dddddd",
                  ...
                  >
                    ...
                    >
                      {CONSTANT.ProfileSettignLogitude}
                    </Text>
                    <TextInput
                      style={{ fontSize: 17, color: '#323232' }}
                      underlineColorAndroid="transparent"
                    ...
                    >{`${entities.decode(longitude)}`}</TextInput>
                  </View>
                  <View
                    style={{
                      borderBottomColor: "#dddddd",
